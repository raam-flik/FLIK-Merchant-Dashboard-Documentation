...
This section covers the login, registration, and password recovery processes for the FLIK Merchant Dashboard.
...
New merchants can create an account using the registration page.
...
After logging in successfully, you'll be directed to the [Dashboard Overview](./dashboard.md).
